    ...
    <Layout>
      <section className="my-12 relative">
        ...
        <div className="relative -top-10 -mt-8 425px:mt-0 425px:absolute 425px:top-2 425px:right-0 bg-white 425px:text-right 425px:w-1/2">
          <a className="inline-block text-navy hover:underline" href="https://www.sec.gov/rules/other.htm">Source</a>
        </div>
        </section>    
      </Layout>
    </>
...
export default OtherOrdersNotices