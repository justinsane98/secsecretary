...
const rssUrl = "https://www.sec.gov/news/speeches.rss";
const sourceUrl = "https://www.sec.gov/news/speeches-statements";

const [todaysSpeeches, setTodaysSpeeches] = useState(0)
...
useEffect(() => {
  ...
  parser.parseURL(rssUrl, function(err, feed) {
    ...
    setTodaysSpeeches(subset)
  })
}, [])

return (
  <>
      <section className={"mb-12 " + (todaysSpeeches.length > 0 ? "block" : "hidden" )}>
